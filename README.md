...
```javascript
import Eureka from 'eurekajs';

// Or, if you're not using a transpiler:
const Eureka = require('eurekajs').Eureka;
...
- Set `statusPageUrl` to a valid URL for your application, Spring Cloud [seems to require this](https://github.com/jquatier/eurekajs/issues/113) when the instance information is parsed.
- Put single quotes around boolean `@enabled`. Unfortunately, a 500 error regarding parsing [seems to occur](https://github.com/jquatier/eurekajs/issues/63) without that.
